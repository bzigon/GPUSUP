...
def DoProcessColumns(trainingInputFile, DoUnion, DataDir, testingInputFile, confusionInputFile):
   print('\n****DoProcessColumns')
   if DoUnion:
   ...
   if ColumnsMatch == False:
       print("**Error -- Columns don't match in ", trainingInputFile)
       sys.exit(1)

   test_df, ColumnsMatch, numTestingKernels = read_log(testingInputFile, columns)
   if ColumnsMatch == False:
       print("**Error -- Columns don't match in ", testingInputFile)
       sys.exit(1)

   confuse_df, ColumnsMatch, numConfusionKernels = read_log(confusionInputFile, columns)
   if ColumnsMatch == False:
       print("**Error -- Columns don't match in ", confusionInputFile)
       sys.exit(1)

   print('\nFilename {0} has {1} columns '.format(trainingInputFile, len(columns)))
   print('Number of features (columns) {}'.format(len(columns)))
   print('Number of training classes {}'.format(numTrainingKernels))
   print('Number of confusion classes {}\n'.format(numConfusionKernels))
   ...
   apply_normalization(confuse_df, norm_result)
...
#   PL.PivotLogs('DataForPaper-TitanV\\0LogsTitanV-ILP4\log*.txt', 'DataForPaper-TitanV\\0pivotlogs-titanv-ILP4.txt')  

   if 1==1:
      PL.PivotLogs('DataForPaper-TitanV\\0LogsTitanV-1M\log*.txt', 'DataForPaper-TitanV\\0pivotlogs-titanv-1M.txt')
      PL.PivotLogs('DataForPaper-TitanV\\0LogsTitanV-10M\log*.txt', 'DataForPaper-TitanV\\0pivotlogs-titanv-10M.txt')
      PL.PivotLogs('DataForPaper-TitanV\\0LogsTitanV-100M\log*.txt', 'DataForPaper-TitanV\\0pivotlogs-titanv-100M.txt')
      PL.PivotLogs('DataForPaper-TitanV\\0LogsTitanV-FMM\log*.txt', 'DataForPaper-TitanV\\0pivotlogs-titanv-FMM.txt')
      PL.PivotLogs('DataForPaper-TitanV\\0LogsTitanV-MM\log*.txt', 'DataForPaper-TitanV\\0pivotlogs-titanv-MM.txt')
      ...
      PL.PivotLogs('DataForPaper-TitanV\\1LogsTitanV-100M\log*.txt', 'DataForPaper-TitanV\\1pivotlogs-titanv-100M.txt')
      PL.PivotLogs('DataForPaper-TitanV\\1LogsTitanV-FMM\log*.txt', 'DataForPaper-TitanV\\1pivotlogs-titanv-FMM.txt')
      PL.PivotLogs('DataForPaper-TitanV\\1LogsTitanV-MM\log*.txt', 'DataForPaper-TitanV\\1pivotlogs-titanv-MM.txt')
      PL.PivotLogs('DataForPaper-TitanV\\1LogsTitanV-Stencil5\log*.txt', 'DataForPaper-TitanV\\1pivotlogs-titanv-Stencil5.txt')
      PL.PivotLogs('DataForPaper-TitanV\\1LogsTitanV-Stencil5SM\log*.txt', 'DataForPaper-TitanV\\1pivotlogs-titanv-Stencil5SM.txt')
   ...
   inputTxtFilesForConfusionMatrix = [
         "DataForPaper-TitanV\\1pivotlogs-titanv-1M.txt",
         "DataForPaper-TitanV\\1pivotlogs-titanv-10M.txt",
         "DataForPaper-TitanV\\1pivotlogs-titanv-100M.txt",
         "DataForPaper-TitanV\\1pivotlogs-titanv-FMM.txt",
         "DataForPaper-TitanV\\0pivotlogs-titanv-MM.txt",
         "DataForPaper-TitanV\\1pivotlogs-titanv-Stencil5.txt",
         "DataForPaper-TitanV\\0pivotlogs-titanv-Stencil5SM.txt",         
         ]
   
   confusionTxtFile = "DataForPaper-TitanV\\pivotlogs-titanv-CONFUSION.txt"
...
#         "DataForPaper-TitanV\\0pivotlogs-titanv-ILP4.txt",
         ...
         "DataForPaper-TitanV\\1pivotlogs-titanv-Stencil5SM.txt"
         ]
